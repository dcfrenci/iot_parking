...
### Arduino
* Connect all hardware following the schematics ([*~/Media/circuit_schema.pdf*](Media/circuit_schema.pdf)) to create the circuit:
  <p align="center">
    <img src="Media/circuit_image.png" width="60%" alt="Swipe Gesture Demo" />
  <p>
